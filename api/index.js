const handlers = {
  ...
  'admin-feedback': require('../lib/handlers/admin-feedback'),
  'website-feedback': require('../lib/handlers/website-feedback'),
  'product-review': require('../lib/handlers/product-review'),
  'public-reviews': require('../lib/handlers/public-reviews'),
